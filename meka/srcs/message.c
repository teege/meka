...
static const S2I_TYPE Msg_Translation_Table [] =
{
	...
	__MSG_ADD(MSG_Glasses_Status_Enabled),
	__MSG_ADD(MSG_Glasses_Status_Disabled),
    __MSG_ADD(MSG_Glasses_Status_Auto),
    __MSG_ADD(Msg_Glasses_SBS),
    ...
    __MSG_ADD(Msg_Menu_Video_3DGlasses_Status),
    __MSG_ADD(Msg_Menu_Video_3DGlasses_Status_Enabled),
    __MSG_ADD(Msg_Menu_Video_3DGlasses_Status_Disabled),
    __MSG_ADD(Msg_Menu_Video_3DGlasses_Status_Auto),
    ...
    __MSG_ADD(MSG_Menu_Video_3DGlasses_Uses_SBS),
