...
static void Blit_Fullscreen_Misc(void)
{
    ...
    // Update 3-D Glasses
    if (Glasses.Enabled!=GLASSES_STATUS_DISABLED)
        Glasses_Update();
}
        ...
        switch (Glasses.Mode) {
            ...
            case GLASSES_MODE_SBS:
                if (render_all_frames) {
                    // Render as Left Eye
                    // perfect mirror
                    tom_3d_pos_x1 = g_video.game_area_x1/2;
                    tom_3d_pos_x2 = (g_video.game_area_x2-g_video.game_area_x1)/2 + (g_video.game_area_x1/2);
                    // final gap
                    tom_3d_pos_x2 -= g_video.game_area_x1/2;
                    // Draw
                    al_set_target_bitmap(fs_out);
                    if (g_blit.dst_scale == 1) {
                        al_draw_bitmap_region(src_buffer,
                        ...
                        al_draw_scaled_bitmap(src_buffer,
                                              g_blit.src_pos_x, g_blit.src_pos_y,
                                              g_blit.src_size_x, g_blit.src_size_y,
                                              tom_3d_pos_x1, g_video.game_area_y1,
                                              tom_3d_pos_x2, g_video.game_area_y2 - g_video.game_area_y1,
                                              0x0000);
                    }
                    
                    // render as Right eye
                    // perfect mirror
                    tom_3d_pos_x1 = (g_video.game_area_x2-g_video.game_area_x1)/2 + (g_video.game_area_x1);
                    tom_3d_pos_x2 = (g_video.game_area_x2-g_video.game_area_x1)/2 + (g_video.res_x-g_video.game_area_x2)/2;
                    // final gap
                    tom_3d_pos_x1 += (g_video.res_x-g_video.game_area_x2)/2;
                    tom_3d_pos_x2 -= (g_video.res_x-g_video.game_area_x2)/2;
                    // Draw
                    al_set_target_bitmap(fs_out);
                    if (g_blit.dst_scale == 1) {
                        al_draw_bitmap_region(src_buffer,
