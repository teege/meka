...
enum
{
    ...
    MSG_Glasses_Status_Enabled,
    MSG_Glasses_Status_Disabled,
    MSG_Glasses_Status_Auto,
    Msg_Glasses_SBS,
    ...
    Msg_Menu_Video_3DGlasses_Status,
    Msg_Menu_Video_3DGlasses_Status_Enabled,
    Msg_Menu_Video_3DGlasses_Status_Disabled,
    Msg_Menu_Video_3DGlasses_Status_Auto,
    ...
    MSG_Menu_Video_3DGlasses_Uses_SBS,
