...
void	gui_menus_init()
{
    ...
    menus_ID.glasses_status  = menu_add_menu (menus_ID.glasses, Msg_Get(Msg_Menu_Video_3DGlasses_Status), MENU_ITEM_FLAG_ACTIVE);
    menu_add_item     (menus_ID.glasses_status, Msg_Get(Msg_Menu_Video_3DGlasses_Status_Enabled), NULL, MENU_ITEM_FLAG_ACTIVE | Is_Checked (Glasses.Enabled == GLASSES_STATUS_ENABLED), (t_menu_callback)Glasses_Set_Status, NULL);
    menu_add_item     (menus_ID.glasses_status, Msg_Get(Msg_Menu_Video_3DGlasses_Status_Disabled), NULL, MENU_ITEM_FLAG_ACTIVE | Is_Checked (Glasses.Enabled == GLASSES_STATUS_DISABLED), (t_menu_callback)Glasses_Set_Status, NULL);
    menu_add_item     (menus_ID.glasses_status, Msg_Get(Msg_Menu_Video_3DGlasses_Status_Auto), NULL, MENU_ITEM_FLAG_ACTIVE | Is_Checked (Glasses.Enabled == GLASSES_STATUS_AUTO), (t_menu_callback)Glasses_Set_Status, NULL);
    ...
    menu_add_item     (menus_ID.glasses,  Msg_Get(MSG_Menu_Video_3DGlasses_Uses_SBS),   NULL,			Is_Active (Glasses.Enabled) | Is_Checked (Glasses.Mode == GLASSES_MODE_SBS), (t_menu_callback)Glasses_Switch_Mode_SBS, NULL);
